...
export function Projects() {
  const projects = [
    ...
    {
      title: "OG Confessions",
      description:
        "A spiritual affirmation platform delivering distraction-free, categorized confessions with Telegram integration. Features playback controls, clean UI, admin dashboard, and automatic cleanup system.",
      image: "/placeholder.svg?height=300&width=400",
      technologies: ["Next.js", "Tailwind CSS", "Supabase", "Telegram Bot API", "React"],
      category: "Web App",
      icon: <Users className="h-5 w-5" />,
      githubUrl: "https://github.com/Okwesie/OG_Confessions",
      liveUrl: "https://og-confessions-nj9v.vercel.app",
      featured: true,
    },
    {
      title: "StoryGrid",
      description:
        "A modern social media platform designed for sharing stories and connecting with friends. Includes user authentication, onboarding, responsive design, and real-time interactions.",
      image: "/placeholder.svg?height=300&width=400",
    ...
    {
      title: "University Student Records Management System",
      description:
        "Robust system built with Visual C++ for managing university operations including enrollment, faculty records, course management, and performance tracking with secure role-based access.",
      image: "/placeholder.svg?height=300&width=400",
      technologies: ["Visual C++", "Microsoft Visual Studio", "OOP", "Database Management"],
      category: "Academic System",
      icon: <Users className="h-5 w-5" />,
      githubUrl: "https://github.com/Okwesie",
      liveUrl: null,
    ...
    },
    {
      ...
      description:
        "A secure system enabling teachers to create/manage quizzes and students to take them. Features authentication, role-based access, statistics, responsive UI, and leaderboard.",
      image: "/placeholder.svg?height=300&width=400",
